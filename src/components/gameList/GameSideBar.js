...
const GameSideBar = () => {
  ...
  return (
    <div className={"bg-[#0D0F12] py-[4.25rem] h-[90.7vh]   px-[1.25rem] "}>
      <div
        className={"bg-[#242829] flex flex-col gap-20 px-4 py-11 rounded-full"}
      >
        <Link
          href={"/dashboard/games"}
          className={cn(
            " p-4 text-white rounded-full ",
            pathName === "/dashboard/games" ? "bg-primaryOrange" : "",
          )}
        >
          <svg
            className={" font-bold   "}
